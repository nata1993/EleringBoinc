...
//user provided price can be inserted with coma or dot
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            if (elering.Price < numericalSpecifiedElectricityPrice && allRunningProcesses is "System.Diagnostics.Process (boinc)")    //if process running and price is below specified, continue running boinc
                            {
                        ...
                        catch (IndexOutOfRangeException)    //if there is no process running, this exception is thrown and process is started
                        {
                            ...
                            if (elering.Price < numericalSpecifiedElectricityPrice)   //if price is below 45€/MWh and got data from elering, proceed to start process
                            {
